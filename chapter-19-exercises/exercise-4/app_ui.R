...
intro_panel <- tabPanel(
  ...
  a("article",herf = "https://www.nytimes.com/interactive/2017/08/07/opinion/leonhardt-income-inequality.html"),
  ...
  # text.
  p(em("nothing special"), strong("see the graph"))
)  
...
sidebar_content <- sidebarPanel(
  ...
  sliderInput("percentile", "Income Percentile", min = 0, max = 100, value = 0)
)
...
main_content <- mainPanel(
  ...
  p(a(herf = "http://gabriel-zucman.eu/usdina/"))
)
...
growth_panel <- tabPanel(
  ...
  sidebarLayout(
    sidebar_content <- p("Sidebar panel content goes here"),
    main_content <- p("this is main content")
  ) 
